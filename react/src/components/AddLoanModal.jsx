  ...
  const handleSubmitLoan = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        throw new Error(
          response.error || response.message || "Failed to create loan"
        );
      }
    } catch (error) {
          ...
          <form onSubmit={handleSubmitLoan} className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  onClick={() =>
                    setFormData((prev) => ({ ...prev, type: "given" }))
                  }
                ...
                <button
                  type="button"
                  onClick={() =>
                    setFormData((prev) => ({ ...prev, type: "taken" }))
                  }
                  className={`p-4 rounded-xl border-2 transition-all ${
                    formData.type === "taken"
            ...
            <div>
              ...
              {formData.interestRate && (
                <p className="text-sm text-slate-500 mt-1">
                  Monthly interest rate: {formData.interestRate}% (Annual:{" "}
                  {(parseFloat(formData.interestRate) * 12).toFixed(2)}%)
                </p>
              )}
            </div>
            ...
            <div>
              ...
              />
              <p className="text-sm text-slate-500 mt-1">
                Number of payments expected for this loan
              </p>
            </div>
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                type="submit"
                disabled={
                  submitting || !formData.amount || !formData.interestRate
                }
