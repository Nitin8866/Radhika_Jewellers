    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white rounded-lg sm:rounded-2xl w-full max-w-4xl h-full sm:max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 sm:p-6 border-b border-blue-100 flex-shrink-0">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white shadow-lg">
                <Coins size={24} />
              </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
          ...
          {/* Items */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Silver Items ({loan.items?.length || 0})</h3>
            {loan.items && loan.items.length > 0 ? (
              <div className="space-y-3">
                {loan.items.map((item, index) => (
                  <div key={index} className="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-100 rounded-xl p-4">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                      <div>
                        <span className="text-gray-600 block mb-1 text-sm">Item Name</span>
                        <span className="text-base font-medium text-gray-900">{item.name || 'Silver Item'}</span>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <span className="text-base font-medium text-gray-900">{item.purityK}</span>
                      </div>
                      <div>
                      ...
                      <div className="mt-3">
                        ...
                        <div className="flex gap-2 flex-wrap">
                          {item.images.slice(0, 3).map((image, imgIndex) => (
                            <div key={imgIndex} className="w-16 h-16 rounded-lg overflow-hidden border border-blue-200">
                              <img 
                                src={image} 
              ...
              {!showPaymentOptions ? (
                ...
                <div className="w-full bg-white border rounded-lg shadow-md p-4 flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      className="px-4 py-2 bg-blue-50 border border-blue-200 rounded-lg text-blue-600 font-semibold hover:bg-blue-100"
                      onClick={() => {
                    ...
                    <button
                      className="px-4 py-2 bg-green-50 border border-green-200 rounded-lg text-green-600 font-semibold hover:bg-green-100"
                      onClick={() => {
                        setShowPaymentOptions(false);
...
export default SilverLoanTableRow;
