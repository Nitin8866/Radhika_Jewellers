        ...
        <div className="flex flex-wrap gap-3 items-center">
          <div className="relative flex-1 min-w-[200px]">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent w-full text-sm"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent min-w-[120px] text-sm"
          >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`p-2 rounded-lg ${viewMode === 'grid' ? 'bg-gray-100 text-gray-600' : 'text-gray-400 hover:text-gray-600'} transition-colors`}
              title="Grid View"
            >
              <Grid size={20} />
            </button>
            <button
              ...
              className={`p-2 rounded-lg ${viewMode === 'list' ? 'bg-gray-100 text-gray-600' : 'text-gray-400 hover:text-gray-600'} transition-colors`}
              title="List View"
            >
              <List size={20} />
            </button>
